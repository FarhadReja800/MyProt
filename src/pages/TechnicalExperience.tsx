...
const TechnicalExperience: React.FC = () => {
  return (
    <section id="tech-stack" className="relative min-h-screen py-32 bg-transparent overflow-hidden">
      
      {/* Decorative Background Elements */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-[#C7A750] opacity-[0.03] blur-[150px] rounded-full" />
        <div className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-[#C7A750] opacity-[0.02] blur-[150px] rounded-full" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-24">
          ...
          >
            <span className="text-[#C7A750] text-[10px] font-black tracking-[0.5em] uppercase mb-4 block">Powering my creations with</span>
            ...
            <div className="h-1 w-24 bg-[#C7A750] mx-auto rounded-full" />
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-8">
          {techStack.map((tech, index) => (
            ...
            >
              <div className="relative z-10 flex flex-col items-center p-4 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] bg-[#111111]/40 border border-white/5 backdrop-blur-sm hover:border-[#C7A750]/30 transition-all duration-500 overflow-hidden shadow-2xl">
                
                {/* Glow Effect on Hover */}
                <div className="absolute inset-0 bg-gradient-to-b from-[#C7A750]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                <div className="relative w-12 h-12 md:w-20 md:h-20 mb-3 md:mb-6 flex items-center justify-center">
                  {/* Orbiting Ring */}
                  <div className="absolute inset-0 rounded-full border border-white/10 group-hover:border-[#C7A750]/50 group-hover:scale-110 transition-all duration-700" />
                ...
                <div className="text-center relative z-10">
                  ...
                  <p className="text-[7px] md:text-[8px] font-bold tracking-[0.2em] text-gray-500 group-hover:text-[#C7A750] transition-colors">
                    {tech.category}
                  </p>
                </div>
              </div>
